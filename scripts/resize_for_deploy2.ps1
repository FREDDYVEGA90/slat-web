...
Resize-Png (Join-Path $root "assets\logo-slat.png") 280
Resize-Jpeg (Join-Path $root "assets\camaron.jpg") 480 60
Resize-Jpeg (Join-Path $root "assets\banano.jpg") 480 60
Resize-Jpeg (Join-Path $root "assets\cacao.jpg") 300 65
